...
def run_quadratic_adx_v3():
    ...
    # Fine-Tuning Grid Search V3
    # Best: A=0.6, B=-30, C=160
    ...
    print(f"ADX V3 Loop ({len(As)*len(Bs)*len(Cs)} combos)...")
    ...
    print("\n=== QUADRATIC ADX V3 RESULTS ===")
    top = results[0]
    print(f"Best: {top['Config']} => {top['CAGR']*100:.2f}%")

if __name__ == "__main__":
    run_quadratic_adx_v3()
